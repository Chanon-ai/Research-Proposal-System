...
const DEFAULT_EMAIL_TEMPLATES = {
  ...
  finance_officer_assigned: {
    subject: 'แจ้งมอบหมายตรวจสอบงบประมาณ - {{proposalCode}}',
    body: 'เรียน {{recipientName}}\n\nท่านได้รับมอบหมายให้ตรวจสอบงบประมาณของโครงการ {{projectTitle}}\n\nรหัสโครงการ: {{proposalCode}}\n\nกรุณาเข้าสู่ระบบเพื่อตรวจสอบรายละเอียดงบประมาณและบันทึกผลกลับเข้าสู่ระบบ\n\nขอแสดงความนับถือ\nส่วนบริหารงานวิจัย มหาวิทยาลัยแม่ฟ้าหลวง'
  },
  finance_review_submitted: {
    subject: 'ได้รับผลการตรวจสอบงบประมาณ - {{proposalCode}}',
    body: 'เรียน {{recipientName}}\n\nเจ้าหน้าที่การเงินได้ส่งผลการตรวจสอบงบประมาณของโครงการ {{projectTitle}} แล้ว\n\nรหัสโครงการ: {{proposalCode}}\nหมายเหตุ: {{remarks}}\n\nกรุณาเข้าสู่ระบบเพื่อตรวจสอบรายละเอียดและดำเนินการขั้นตอนถัดไป\n\nขอแสดงความนับถือ\nส่วนบริหารงานวิจัย มหาวิทยาลัยแม่ฟ้าหลวง'
  },
  review_certified: {
