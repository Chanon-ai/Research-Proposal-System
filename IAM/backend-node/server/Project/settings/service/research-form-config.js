...
const PROPOSAL_WORKFLOW_DEFAULT = Object.freeze({
  ...
  allowedTransitions: {
    ...
    faculty_review_pending: ['faculty_approved', 'revision_requested', 'rejected'],
    ...
    finance_budget_checking: ['document_checking', 'revision_requested'],
...
const ROLE_PAGE_ACCESS_DEFAULT = Object.freeze([
  ...
  { pageKey: 'user-profile', label: 'โปรไฟล์ผู้วิจัย', path: '/user/profile', matchMode: 'exact', roles: ['researcher'] },
  { pageKey: 'user-history', label: 'ประวัติการยื่นโครงการ', path: '/user/history', matchMode: 'exact', roles: ['researcher'] },
  { pageKey: 'user-notification', label: 'การแจ้งเตือนผู้วิจัย', path: '/user/notification', matchMode: 'exact', roles: ['researcher'] },
  { pageKey: 'user-meetings', label: 'ตารางประชุมผู้วิจัย', path: '/user/meetings', matchMode: 'exact', roles: ['researcher'] },
  ...
  { pageKey: 'admin-dashboard', label: 'แดชบอร์ดแอดมิน', path: '/admin/dashboard', matchMode: 'exact', roles: ['admin'] },
  { pageKey: 'admin-proposals', label: 'จัดการโครงการ', path: '/admin/proposals', matchMode: 'prefix', roles: ['admin'] },
  { pageKey: 'admin-documents', label: 'เอกสารโครงการ', path: '/admin/documents', matchMode: 'exact', roles: ['admin'] },
  { pageKey: 'admin-users', label: 'จัดการผู้ใช้งาน', path: '/admin/users', matchMode: 'exact', roles: ['admin'] },
  { pageKey: 'admin-meetings', label: 'จัดการประชุม', path: '/admin/meetings', matchMode: 'exact', roles: ['admin'] },
  { pageKey: 'admin-notifications', label: 'การแจ้งเตือนแอดมิน', path: '/admin/notifications', matchMode: 'exact', roles: ['admin'] },
  { pageKey: 'admin-reports', label: 'รายงาน', path: '/admin/reports', matchMode: 'exact', roles: ['admin'] },
  { pageKey: 'admin-settings', label: 'ตั้งค่าระบบ', path: '/admin/settings', matchMode: 'exact', roles: ['admin'], requiredRoles: ['admin'] },
  { pageKey: 'committee-dashboard', label: 'แดชบอร์ดคณะกรรมการ', path: '/committee/dashboard', matchMode: 'exact', roles: ['committee'] },
  { pageKey: 'committee-assigned', label: 'รายการที่ได้รับมอบหมาย', path: '/committee/assigned', matchMode: 'exact', roles: ['committee'] },
  { pageKey: 'committee-meetings', label: 'ประชุมคณะกรรมการ', path: '/committee/meetings', matchMode: 'exact', roles: ['committee'] },
  { pageKey: 'committee-notifications', label: 'การแจ้งเตือนคณะกรรมการ', path: '/committee/notifications', matchMode: 'exact', roles: ['committee'] },
  { pageKey: 'committee-proposals', label: 'หน้าอ่านข้อเสนอของกรรมการ', path: '/committee/proposals', matchMode: 'prefix', roles: ['committee'] },
  { pageKey: 'chairman-dashboard', label: 'แดชบอร์ดประธานสำนัก', path: '/chairman/dashboard', matchMode: 'exact', roles: ['chairman'] },
  { pageKey: 'chairman-assigned', label: 'รายการที่ได้รับมอบหมายประธานสำนัก', path: '/chairman/assigned', matchMode: 'exact', roles: ['chairman'] },
