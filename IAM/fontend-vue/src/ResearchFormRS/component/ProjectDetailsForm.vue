...
export default {
  ...
  computed: {
    ...
    formText() {
      ...
      return {
        cardTitle: '1-19 รายละเอียดโครงการ',
        section1Title: '1. ชื่อโครงการ',
        section2Title: '2. ประเภททุน',
        section3Title: '3. องค์กรร่วมดำเนินการ',
        section4Title: '4. ประเภทงานวิจัย',
        section5Title: '5. คำสำคัญ (Keywords)',
        section6Title: '6. ความสำคัญของปัญหาและแนวคิด',
        section7Title: '7. วัตถุประสงค์',
        section8Title: '8. ทบทวนวรรณกรรม',
        section9Title: '9. เอกสารอ้างอิง',
        section10Title: '10. วิธีดำเนินการวิจัย',
        section11Title: '11. ขอบเขตการวิจัย',
        section12Title: '12. แผนการดำเนินงาน',
        section13Title: '13. ผลงานตามระยะเวลาการรายงาน',
        section14Title: '14. ผลลัพธ์ที่คาดว่าจะได้รับ',
        section15Title: '15. การบูรณาการงานวิจัย',
        section16Title: '16. ระดับการถ่ายทอดสู่สังคม',
        section17Title: '17. งบประมาณโครงการ',
        projectNameThaiLabel: 'ชื่อโครงการ (ภาษาไทย)',
        projectNameThaiPlaceholder: 'ระบุชื่อโครงการเป็นภาษาไทย',
        projectNameThaiHint: 'กรุณาระบุชื่อโครงการภาษาไทย (อนุญาตให้มีตัวเลขและสัญลักษณ์) *',
        projectNameEnglishLabel: 'ชื่อโครงการ (ภาษาอังกฤษ)',
    ...
    fundingSubSelectionStatusText() {
      return this.isFundingSubSelectionComplete ? (this.isEnglishLocale ? 'Complete' : 'สมบูรณ์') : (this.isEnglishLocale ? 'Incomplete' : 'ไม่สมบูรณ์')
    },
  ...
  methods: {
    ...
    buildFundingTypeOptions(config) {
      ...
      return normalizedConfig.map((fundingType, typeIndex) => {
        ...
        const subSectionTitle = fallbackSubSectionTitle || (mappedSubOptions.length ? (this.isEnglishLocale ? 'Research framework (select 1)' : 'กรอบงานวิจัย (เลือก 1 รายการ)') : '')
