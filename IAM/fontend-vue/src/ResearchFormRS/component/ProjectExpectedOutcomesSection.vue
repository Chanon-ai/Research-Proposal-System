  ...
  computed: {
    ...
    sectionLabels() {
      return this.isEnglishLocale
        ...
        : {
            ...
            'strategic-research': '14.3 ทุนวิจัยเชิงยุทธศาสตร์',
            'industry-extension': '14.4 ทุนส่งเสริมอุตสาหกรรม'
          }
    },
    outcomeOptionDictionary() {
      return this.isEnglishLocale
        ...
        : {
            internationalConference: {
              value: 'internationalConference',
              label: 'การนำเสนอผลงานในที่ประชุมวิชาการนานาชาติ (Proceedings)',
              description: 'เผยแพร่ผลงานวิจัยในการประชุมวิชาการระดับนานาชาติ'
            },
            scopusJournal: {
              value: 'scopusJournal',
              label: 'ตีพิมพ์ในวารสารวิชาการนานาชาติในฐานข้อมูลที่ยอมรับ',
              description: 'ตีพิมพ์บทความวิจัยในวารสารที่ได้รับการยอมรับในระดับนานาชาติ'
            },
            tciJournal: {
              value: 'tciJournal',
            ...
            ipRegistration: {
              value: 'ipRegistration',
              label: 'การยื่นขอจดทะเบียนทรัพย์สินทางปัญญา (มีเลขคำขอ)',
              description: 'ยื่นขอจดทะเบียนทรัพย์สินทางปัญญาเพื่อการนำไปใช้ประโยชน์ในอนาคต'
            }
          }
    },
    chooseFundingFirstText() {
      return this.isEnglishLocale
        ...
        : 'กรุณาเลือก "ประเภททุน" ในส่วนที่ 2 ก่อนเลือกผลลัพธ์'
    },
    introText() {
      return this.isEnglishLocale
        ? 'Select 1 expected outcome that matches the selected funding type.'
        : 'เลือก 1 ผลลัพธ์ที่คาดว่าจะได้รับ ที่สอดคล้องกับประเภททุนที่เลือก'
    },
    promptText() {
      return this.isEnglishLocale
        ? 'Please select 1 expected outcome'
        : 'กรุณาเลือก 1 ผลลัพธ์ที่คาดว่าจะได้รับ'
    },
    hasFundingType() {
