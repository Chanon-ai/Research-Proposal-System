...
export default {
  ...
  computed: {
    ...
    teamText() {
      ...
      return {
        cardTitle: 'คณะผู้วิจัย',
        projectLeaderTitle: 'หัวหน้าโครงการวิจัย',
        fullNameLabel: 'ชื่อ-นามสกุล',
        affiliationLabel: 'สังกัด/หน่วยงาน',
        phoneLabel: 'หมายเลขโทรศัพท์',
        proportionLabel: 'สัดส่วนงานวิจัย (%)',
        autoCalculatedTitle: 'คำนวณอัตโนมัติจากสัดส่วนของผู้วิจัยร่วม',
        coResearchersTitle: 'ผู้วิจัยร่วม (ถ้ามี)',
        noCoResearchers: '-- ไม่มีข้อมูลผู้วิจัยร่วม --',
        removeCoResearcherTitle: 'ลบผู้วิจัยร่วม',
        removeButton: 'ลบ',
        addCoResearcherButton: 'เพิ่มผู้วิจัยร่วม',
        addCoResearcherModalTitle: 'เพิ่มผู้วิจัยร่วม',
        coResearcherPickerLabel: 'ค้นหา / เลือกผู้วิจัยร่วม (เลือกได้หลายคน)',
        coResearcherSearchPlaceholder: 'ค้นหาด้วยชื่อ อีเมล หรือสังกัด',
        cancelButton: 'ยกเลิก',
        totalProportionLabel: 'สัดส่วนงานวิจัยรวมทั้งหมด',
  ...
  methods: {
    ...
    async fetchCoResearcherOptions() {
      ...
      try {
        ...
        this.coResearcherOptionsError = this.isEnglishLocale ? 'Unable to load researcher list' : 'ไม่สามารถโหลดรายชื่อนักวิจัยได้'
      } finally {
