          ...
          <CCardBody>
            ...
            <CRow class="text-right mt-3">
              <CCol>
                ...
                <CButton class="ml-2" size="sm" :color="objs.color" shape="pill" variant="outline" @click="onSubmit(objs.code)" v-for="(objs, index) in message.button" :key="`${objs.code || 'btn'}-${index}`">
